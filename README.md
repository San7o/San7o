...
- [povOS](https://github.com/San7o/povOS): an operating system for an IBM-compatible PC using the x86_64 architecture. Supports virtual memory, multitasking and some drivers, with a custom bootloader.
