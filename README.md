...
I am a 22yo System Software Engineer. I have a keen interest in bootloaders, operating systems, networking, virtualization and game engines. I work close to Linux embedded systems (U-boot, IIO, netdev, yocto...) and server infrastructure (KVM, eBPF, qemu, proxmox, Kubernetes...), with an eye on cybersecurity.
...
- [micro-tests.h](https://github.com/San7o/micro-tests.h): lightweight testing framework, with multithread support and run-time settings
